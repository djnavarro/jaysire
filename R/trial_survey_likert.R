...
#' a set of questions with Likert scale responses. The \code{questions} argument is
#' used to specify the questions themselves, and can either consist of a single
#' question object generated by \code{\link{question_likert}} or a list of such objects.
