...
#'
#' @details The \code{trial_html_keyboard_response} function belongs to the "stimulus-response"
...
#' This one displays HTML and records responses generated with a key press.
#'
