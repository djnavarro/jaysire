...
#'
#' @details The \code{trial_video_keyboard_response} function belongs to the "stimulus-response"
...
#' This one plays a video and records responses generated with a key press.
#'
