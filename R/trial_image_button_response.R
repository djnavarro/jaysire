...
#'
#' @description The \code{trial_image_button_response} function is used to display
...
#'
#'
#' @details The \code{trial_image_button_response} function belongs to the "stimulus-response"
...
#' This one displays an image and records responses generated with a button click.
#'
