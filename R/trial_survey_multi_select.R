...
#'
#' @details The \code{trial_survey_multi_select} function creates a trial that displays
#' a set of questions with multiple selection responses. The \code{questions} argument is
...
#' The multiple selection items are laid out as a set of check boxe with labels specified
#' when calling \code{\link{question_multi}}, and the participant can select as many
