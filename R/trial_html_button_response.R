...
#'
#'
#' @details The \code{trial_html_button_response} function belongs to the "stimulus-response"
...
#' This one displays HTML and records responses generated with a button click.
#'
